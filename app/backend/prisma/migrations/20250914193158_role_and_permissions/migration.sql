...
-- CreateIndex
CREATE INDEX "role_assignments_userId_idx" ON "public"."role_assignments"("userId");

-- CreateIndex
CREATE INDEX "role_assignments_roleId_idx" ON "public"."role_assignments"("roleId");

-- CreateIndex
CREATE INDEX "role_assignments_assignedBy_idx" ON "public"."role_assignments"("assignedBy");

-- CreateIndex
CREATE INDEX "role_assignments_expiresAt_idx" ON "public"."role_assignments"("expiresAt");

-- CreateIndex
CREATE INDEX "role_assignments_isActive_idx" ON "public"."role_assignments"("isActive");
